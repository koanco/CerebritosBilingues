...
public class FrutasActivity extends AppCompatActivity implements View.OnTouchListener, View.OnDragListener {
    private String[] listaFrutas = {"Orange", "Banana", "Grape", "Apple", "Strawberry"};
    private int[] listaAudios ={R.raw.orange,R.raw.banana,R.raw.grape,R.raw.apple,R.raw.strawberry};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        principal = (LinearLayout) findViewById(R.id.lprincipalFrutas);
        izquierda = (LinearLayout) findViewById(R.id.layout1Frutas);
        centro = (LinearLayout) findViewById(R.id.layout2Frutas);
        derecha = (LinearLayout) findViewById(R.id.layout3Frutas);
        tWord = (TextView) findViewById(R.id.tWordFrutas);
        // fondo=(ImageView)findViewById(R.id.fondo);
        principal.setOnDragListener(this);
        findViewById(R.id.layoutSonidoFrutas).setOnDragListener(this);
        izquierda.setOnDragListener(this);
        centro.setOnDragListener(this);
        derecha.setOnDragListener(this);
        tWord.setText(listaFrutas[0]);
       fallo=(ImageView)findViewById(R.id.falloFruta);
        padre=(LinearLayout)findViewById(R.id.lPadreFrutas);
            ...
            case DragEvent.ACTION_DROP:
              ...
              */
                ...
                if(listaImagenes.get(posicion)!=null) {
                    try{
                        if (view.equals(listaImagenes.get(posicion)) && v.getId() == R.id.lprincipalFrutas) {
                            ...
                            if (source != null) {
                                ...
                                if (posicion < 5) {
                                    tWord.setText(listaFrutas[posicion]);
...
//                           linearBackup.addView(view);
    ...
    public void actualizar()
    {
        ...
        if(cant==1)
        {
            Toast.makeText(this,"Se modificó el puntaje de frutas del usuario",Toast.LENGTH_SHORT).show();

        }
        else
        {

            Toast.makeText(this,"No fue posible modificar  el puntaje de frutas del usuario ",Toast.LENGTH_SHORT).show();
    ...
    private void cargarImagenes()
    {
        for(int i=0;i<5;i++)
        {
            ...
            switch (i)
            {
                ...
                break;
                case 1:
                    imagen.setImageResource(R.drawable.banano);
                    break;
                case 2:
                    imagen.setImageResource(R.drawable.uva);
                    break;
                case 3:
                    imagen.setImageResource(R.drawable.manzana);
                    break;
                case 4:
                    imagen.setImageResource(R.drawable.fresa);
                    break;
